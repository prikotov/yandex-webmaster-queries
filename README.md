...
1. **Топ-20 по показам** — где вы уже видны в поиске
2. **Позиции 5-15** — легче всего попасть в топ-3
3. **Высокий CTR при низкой позиции** — хороший контент, нужно больше ссылок
